                    ...
                    @if ($categories->count() > 0)
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <th>@lang('site.books_count')</th>
                                <th>@lang('site.related_books')</th>
                            ...
                            @foreach ($categories as $index=>$category)
                                <tr>
                                    ...
                                    <td><a href="{{ route('dashboard.books.index', ['category_id' => $category->id]) }}" class="btn btn-info btn-sm">@lang('site.related_books')</a></td>
                                    <td>
